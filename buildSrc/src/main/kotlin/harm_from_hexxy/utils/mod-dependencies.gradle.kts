...
abstract class HarmFromHexxyModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HarmFromHexxyModDependenciesExtension>("harmfromhexxyModDependencies")
