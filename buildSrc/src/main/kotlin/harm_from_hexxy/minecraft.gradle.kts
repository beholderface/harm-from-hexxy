...
package harm_from_hexxy

import kotlin.io.path.div
import libs

plugins {
    id("harm_from_hexxy.java")
...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/harm_from_hexxy.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: harm_from_hexxy-common-common-refmap.json
        // fixed:   harm_from_hexxy-common.refmap.json
